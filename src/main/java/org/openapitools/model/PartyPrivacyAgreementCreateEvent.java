...
public class PartyPrivacyAgreementCreateEvent   {
  ...
  @JsonProperty("event")
  private PartyPrivacyAgreementCreateEventPayload event;
  ...
  */
  ...
  public PartyPrivacyAgreementCreateEvent eventTime(OffsetDateTime eventTime) {
  ...
  */
  ...
  public PartyPrivacyAgreementCreateEvent timeOcurred(OffsetDateTime timeOcurred) {
