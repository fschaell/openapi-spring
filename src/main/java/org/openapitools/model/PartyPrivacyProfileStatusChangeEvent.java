...
public class PartyPrivacyProfileStatusChangeEvent   {
  ...
  @JsonProperty("event")
  private PartyPrivacyProfileStatusChangeEventPayload event;
  ...
  */
  ...
  public PartyPrivacyProfileStatusChangeEvent eventTime(OffsetDateTime eventTime) {
  ...
  */
  ...
  public PartyPrivacyProfileStatusChangeEvent timeOcurred(OffsetDateTime timeOcurred) {
