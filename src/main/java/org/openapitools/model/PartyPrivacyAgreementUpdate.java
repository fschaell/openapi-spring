...
public class PartyPrivacyAgreementUpdate   {
  ...
  */
  ...
  public PartyPrivacyAgreementUpdate initialDate(OffsetDateTime initialDate) {
  ...
  */
  ...
  public PartyPrivacyAgreementUpdate addAgreementAuthorizationItem(AgreementAuthorization agreementAuthorizationItem) {
  ...
  */
  ...
  public PartyPrivacyAgreementUpdate addAgreementItemItem(AgreementItem agreementItemItem) {
...
@Size(min=1) 
  ...
  */
  ...
  public PartyPrivacyAgreementUpdate addAssociatedAgreementItem(AgreementRef associatedAgreementItem) {
  ...
  */
  ...
  public PartyPrivacyAgreementUpdate addCharacteristicItem(Characteristic characteristicItem) {
  ...
  */
  ...
  public PartyPrivacyAgreementUpdate addEngagedPartyRoleItem(RelatedParty engagedPartyRoleItem) {
...
@Size(min=1) 
  ...
  public PartyPrivacyAgreementUpdate addPartyPrivacyProfileItem(PartyPrivacyProfileRef partyPrivacyProfileItem) {
  ...
  */
  ...
  public PartyPrivacyAgreementUpdate addPartyPrivacyProfileCharacteristicItem(PartyPrivacyProfileCharacteristic partyPrivacyProfileCharacteristicItem) {
