...
public class PartyPrivacyAgreementAttributeValueChangeEvent   {
  ...
  @JsonProperty("event")
  private PartyPrivacyAgreementAttributeValueChangeEventPayload event;
  ...
  */
  ...
  public PartyPrivacyAgreementAttributeValueChangeEvent eventTime(OffsetDateTime eventTime) {
  ...
  */
  ...
  public PartyPrivacyAgreementAttributeValueChangeEvent timeOcurred(OffsetDateTime timeOcurred) {
