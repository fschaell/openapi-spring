...
public class PartyPrivacyProfileDeleteEventPayload   {
  @JsonProperty("partyPrivacyProfile")
  private PartyPrivacyProfile partyPrivacyProfile;

  public PartyPrivacyProfileDeleteEventPayload partyPrivacyProfile(PartyPrivacyProfile partyPrivacyProfile) {
  ...
  */
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PartyPrivacyProfileDeleteEventPayload partyPrivacyProfileDeleteEventPayload = (PartyPrivacyProfileDeleteEventPayload) o;
    return Objects.equals(this.partyPrivacyProfile, partyPrivacyProfileDeleteEventPayload.partyPrivacyProfile);
  }
  ...
  public String toString() {
    ...
    sb.append("class PartyPrivacyProfileDeleteEventPayload {\n");
