...
public class PartyPrivacyProfileSpecificationStatusChangeEvent   {
  ...
  @JsonProperty("event")
  private PartyPrivacyProfileSpecificationStatusChangeEventPayload event;
  ...
  */
  ...
  public PartyPrivacyProfileSpecificationStatusChangeEvent eventTime(OffsetDateTime eventTime) {
  ...
  */
  ...
  public PartyPrivacyProfileSpecificationStatusChangeEvent timeOcurred(OffsetDateTime timeOcurred) {
