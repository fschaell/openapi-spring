...
public class PartyPrivacyProfileAttributeValueChangeEvent   {
  ...
  @JsonProperty("event")
  private PartyPrivacyProfileAttributeValueChangeEventPayload event;
  ...
  */
  ...
  public PartyPrivacyProfileAttributeValueChangeEvent eventTime(OffsetDateTime eventTime) {
  ...
  */
  ...
  public PartyPrivacyProfileAttributeValueChangeEvent timeOcurred(OffsetDateTime timeOcurred) {
